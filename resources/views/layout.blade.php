...
<body>
    ...
    <aside id="logo-sidebar"
        ...
        aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-slate-700">
            <ul class="space-y-2 font-medium">
                <li class="{{ request()->routeIs('dashboard') ? 'bg-orange-500' : 'bg-slate-800' }}">
                ...
                <li class="{{ request()->routeIs('role.index') ? 'bg-orange-500' : 'bg-slate-800' }}">
                ...
                <li class="{{ request()->routeIs('user.index') ? 'bg-orange-500' : 'bg-slate-800' }}">
                ...
                <li class="{{ request()->routeIs('laporan.index') ? 'bg-orange-500' : 'bg-slate-800' }}">
                    <a href="{{ route('laporan.index') }}"
                        ...
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-cyan-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                    </a>
                </li>
            </ul>
        </div>
